...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, array(
    ...
    'vich_uploader.command.mapping_debug' => array('privates', 'vich_uploader.command.mapping_debug', 'getVichUploader_Command_MappingDebugService.php', true),
    'vich_uploader.command.mapping_debug_class' => array('privates', 'vich_uploader.command.mapping_debug_class', 'getVichUploader_Command_MappingDebugClassService.php', true),
    'vich_uploader.command.mapping_list_classes' => array('privates', 'vich_uploader.command.mapping_list_classes', 'getVichUploader_Command_MappingListClassesService.php', true),
