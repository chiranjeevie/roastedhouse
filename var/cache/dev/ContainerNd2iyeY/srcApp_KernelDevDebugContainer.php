...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            'App\\Controller\\UploadImageAction' => 'getUploadImageActionService.php',
            'App\\Controller\\UserAdminController' => 'getUserAdminControllerService.php',
            ...
            'Vich\\UploaderBundle\\Naming\\UniqidNamer.courses' => 'getUniqidNamer_CoursesService.php',
            ...
            'console.command.public_alias.Gesdinet\\JWTRefreshTokenBundle\\Command\\ClearInvalidRefreshTokensCommand' => 'getClearInvalidRefreshTokensCommandService.php',
            'console.command.public_alias.Gesdinet\\JWTRefreshTokenBundle\\Command\\RevokeRefreshTokenCommand' => 'getRevokeRefreshTokenCommandService.php',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'/src/Serializer/UserAttributeNormalizer.php';
            ...
            include_once $this->targetDirs[3].'/src/Serializer/UserContextBuilder.php';
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('s+M0Z2Ddq8', 0, ($this->targetDirs[0].'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.view', array(0 => function () {
            return ($this->privates['App\EventSubscriber\AuthoredEntitySubscriber'] ?? $this->load('getAuthoredEntitySubscriberService.php'));
        }, 1 => 'getAuthenticatedUser'), 33);
        $instance->addListener('kernel.view', array(0 => function () {
            return ($this->privates['App\EventSubscriber\CourseSeekerSubscriber'] ?? $this->load('getCourseSeekerSubscriberService.php'));
        }, 1 => 'encodePassword'), 33);
        $instance->addListener('kernel.view', array(0 => function () {
            return ($this->privates['App\EventSubscriber\UserPasswordEncoderSubscriber'] ?? $this->load('getUserPasswordEncoderSubscriberService.php'));
        }, 1 => 'encodePassword'), 33);
        $instance->addListener('kernel.response', array(0 => function () {
    ...
    protected function getSerializerService()
    {
        ...
        return $this->services['serializer'] = new \Symfony\Component\Serializer\Serializer(array(0 => new \App\Serializer\UserAttributeNormalizer(($this->services['security.token_storage'] ?? ($this->services['security.token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()))), 1 => new \ApiPlatform\Core\Hydra\Serializer\ConstraintViolationListNormalizer($a, array(), NULL), 2 => new \ApiPlatform\Core\Hydra\Serializer\DocumentationNormalizer($b, $c, $d, $e, ($this->privates['api_platform.operation_method_resolver'] ?? $this->getApiPlatform_OperationMethodResolverService()), $a, ($this->privates['api_platform.subresource_operation_factory.cached'] ?? $this->getApiPlatform_SubresourceOperationFactory_CachedService()), NULL), 3 => new \ApiPlatform\Core\Hydra\Serializer\EntrypointNormalizer($b, $f, $a), 4 => new \ApiPlatform\Core\Hydra\Serializer\ErrorNormalizer($a, true), 5 => $g, 6 => $g, 7 => new \ApiPlatform\Core\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Core\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Core\Hydra\Serializer\CollectionNormalizer($h, $e, $f), '_page', 'pagination'), $b, $e, ($this->privates['api_platform.filter_locator'] ?? ($this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, array())))), 8 => new \ApiPlatform\Core\Problem\Serializer\ConstraintViolationListNormalizer(array(), NULL), 9 => new \ApiPlatform\Core\JsonLd\Serializer\ItemNormalizer($b, $c, $d, $f, $e, $h, $i, NULL, $j), 10 => new \ApiPlatform\Core\Problem\Serializer\ErrorNormalizer(true), 11 => new \ApiPlatform\Core\GraphQl\Serializer\ItemNormalizer($c, $d, $f, $e, $i, NULL, $j, $k, false), 12 => new \ApiPlatform\Core\Serializer\ItemNormalizer($c, $d, $f, $e, $i, NULL, $j, $k, false), 13 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(), 14 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 15 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer(), 16 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 17 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(), 18 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 19 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($j, new \Symfony\Component\Serializer\NameConverter\MetadataAwareNameConverter($j), $i, ($this->privates['property_info'] ?? $this->getPropertyInfoService()), new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($j))), array(0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => new \Symfony\Component\Serializer\Encoder\JsonEncoder(), 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonld'), 5 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonproblem')));
    }
    ...
    protected function getApiPlatform_Serializer_ContextBuilder_FilterService()
    {
        ...
        return $this->privates['api_platform.serializer.context_builder.filter'] = new \ApiPlatform\Core\Serializer\SerializerFilterContextBuilder($a, ($this->privates['api_platform.filter_locator'] ?? ($this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, array()))), new \App\Serializer\UserContextBuilder(new \ApiPlatform\Core\Serializer\SerializerContextBuilder($a), ($this->services['security.authorization_checker'] ?? $this->getSecurity_AuthorizationCheckerService())));
    }
    ...
    protected function getApiPlatform_Swagger_Normalizer_ApiGatewayService()
    {
        ...
        return $this->privates['api_platform.swagger.normalizer.api_gateway'] = new \ApiPlatform\Core\Swagger\Serializer\ApiGatewayNormalizer(new \ApiPlatform\Core\Swagger\Serializer\DocumentationNormalizer(($this->privates['api_platform.metadata.resource.metadata_factory.cached'] ?? $this->getApiPlatform_Metadata_Resource_MetadataFactory_CachedService()), ($this->privates['api_platform.metadata.property.name_collection_factory.cached'] ?? $this->getApiPlatform_Metadata_Property_NameCollectionFactory_CachedService()), ($this->privates['api_platform.metadata.property.metadata_factory.cached'] ?? $this->getApiPlatform_Metadata_Property_MetadataFactory_CachedService()), ($this->privates['api_platform.resource_class_resolver'] ?? $this->getApiPlatform_ResourceClassResolverService()), ($this->privates['api_platform.operation_method_resolver'] ?? $this->getApiPlatform_OperationMethodResolverService()), new \ApiPlatform\Core\Bridge\Symfony\Routing\RouterOperationPathResolver(($this->privates['api_platform.router'] ?? $this->getApiPlatform_RouterService()), ($this->privates['api_platform.operation_path_resolver.custom'] ?? $this->getApiPlatform_OperationPathResolver_CustomService()), $a), NULL, ($this->privates['api_platform.filter_locator'] ?? ($this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, array()))), NULL, false, 'oauth2', 'application', '/oauth/v2/token', '/oauth/v2/auth', array(), array(), $a, true, '_page', true, 'itemsPerPage', ($this->privates['api_platform.formats_provider'] ?? $this->getApiPlatform_FormatsProviderService())));
    }
    ...
    protected function getDebug_Security_FirewallService()
    {
        return $this->privates['debug.security.firewall'] = new \Symfony\Bundle\SecurityBundle\Debug\TraceableFirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, array(
            ...
            'security.firewall.map.context.apidoc' => array('privates', 'security.firewall.map.context.apidoc', 'getSecurity_Firewall_Map_Context_ApidocService.php', true),
            ...
            'security.firewall.map.context.refresh' => array('privates', 'security.firewall.map.context.refresh', 'getSecurity_Firewall_Map_Context_RefreshService.php', true),
        )), new RewindableGenerator(function () {
            ...
            yield 'security.firewall.map.context.apidoc' => ($this->privates['.security.request_matcher.PfIwdrL'] ?? ($this->privates['.security.request_matcher.PfIwdrL'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/docs')));
    ...
    protected function getForm_RegistryService()
    {
        return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, array(
            'App\\Form\\ImageType' => array('privates', 'App\\Form\\ImageType', 'getImageTypeService.php', true),
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            ...
            yield 6 => ($this->privates['security.authentication.provider.anonymous.apidoc'] ?? ($this->privates['security.authentication.provider.anonymous.apidoc'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))));
        }, 7), true);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'api_platform.resource_class_directories': $value = array(
                ...
                1 => ($this->targetDirs[3].'/vendor/gesdinet/jwt-refresh-token-bundle/Entity'),
                2 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Entity'),
            ); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'security.role_hierarchy.roles' => array(
                ...
                'ROLE_MARKETING_MANAGER' => array(
                    0 => 0,
                    1 => 4,
                ),
                'ROLE_SALES_MANAGER' => array(
                    0 => 0,
                    1 => 3,
                    2 => 4,
                ),
                'ROLE_COURSE_MANGER' => array(
                    0 => 0,
                    1 => 2,
                    2 => 3,
                    3 => 4,
            ...
            'api_platform.collection.pagination.maximum_items_per_page' => 20,
            'api_platform.collection.pagination.page_parameter_name' => '_page',
            ...
            'easyadmin.config' => array(
                ...
                'entities' => array(
                    ...
                    'NetSuiteConfiguration' => array(
                        ...
                        'list' => array(
                            'help' => 'NetSuite API Configuration.',
                            'actions' => array(
                                0 => array(
                                    'name' => 'show',
                                    'icon' => 'info-circle',
                        ...
                        'name' => 'NetSuiteConfiguration',
                    ),
                    'RevelConfiguration' => array(
                        ...
                        'name' => 'RevelConfiguration',
                    ),
                    'NetsuiteToRevelHistory' => array(
                        ...
                        'list' => array(
                            'help' => 'Netsuite To Revel History.',
                            'actions' => array(
                                0 => array(
                                    'name' => 'show',
                                    'icon' => 'info-circle',
                        ...
                        'name' => 'NetsuiteToRevelHistory',
                    ),
                    'RevelToNetsuiteHistory' => array(
                        ...
                        'list' => array(
                            'help' => 'Revel To Netsuite History.',
                            'actions' => array(
                                0 => array(
                                    'name' => 'show',
                                    'icon' => 'info-circle',
                    ...
                    'SyncHistory' => array(
                        ...
                        'list' => array(
                            'help' => 'Most Recent Scheduler history!',
                            'actions' => array(
                                0 => array(
                                    'name' => 'show',
                                    'icon' => 'info-circle',
            ...
            'vich_uploader.mappings' => array(
                'courses' => array(
                    ...
                    'namer' => array(
                        'service' => 'Vich\\UploaderBundle\\Naming\\UniqidNamer.courses',
                        'options' => array(
            ...
            'console.command.ids' => array(
                0 => 'console.command.public_alias.api_platform.swagger.command.swagger_command',
                ...
                12 => 'console.command.public_alias.Gesdinet\\JWTRefreshTokenBundle\\Command\\ClearInvalidRefreshTokensCommand',
                13 => 'console.command.public_alias.Gesdinet\\JWTRefreshTokenBundle\\Command\\RevokeRefreshTokenCommand',
            ),
        );
    }
}
