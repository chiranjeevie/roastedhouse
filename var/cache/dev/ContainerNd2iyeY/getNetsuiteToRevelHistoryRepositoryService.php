...
// Returns the private 'App\Repository\NetsuiteToRevelHistoryRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/NetsuiteToRevelHistoryRepository.php';

return $this->privates['App\Repository\NetsuiteToRevelHistoryRepository'] = new \App\Repository\NetsuiteToRevelHistoryRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
