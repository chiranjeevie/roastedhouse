...
// Returns the private 'App\Repository\SyncHistoryRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SyncHistoryRepository.php';

return $this->privates['App\Repository\SyncHistoryRepository'] = new \App\Repository\SyncHistoryRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
