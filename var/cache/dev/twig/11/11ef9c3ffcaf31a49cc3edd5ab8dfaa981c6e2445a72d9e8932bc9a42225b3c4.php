...
class __TwigTemplate_c857fb8db593b2b5f079188ba64b0425861cbc5a98bded30d1d383df5cfd50df extends Twig_Template
{
    private $source;
...
";
    ...
    <p id=\"<?php echo \$view->escape(\$id); ?>_help\" <?php echo ' '.\$view['form']->block(\$form, 'attributes', array('attr' => \$help_attr)); ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$help, array(), \$translation_domain) : \$help); ?></p>
<?php endif; ?>
", "@Framework/Form/form_help.html.php", "/home/chiranjeevie/projects/courses/api/vendor/symfony/framework-bundle/Resources/views/Form/form_help.html.php");
    }
}
