...
$b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), $this->getParameter('api_platform.resource_class_directories'));
$c = new \Doctrine\ORM\Mapping\Driver\YamlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array(($this->targetDirs[3].'/vendor/gesdinet/jwt-refresh-token-bundle/Resources/config/orm/doctrine-orm') => 'Gesdinet\\JWTRefreshTokenBundle\\Entity', ($this->targetDirs[3].'/vendor/gesdinet/jwt-refresh-token-bundle/Resources/config/orm/doctrine-entity') => 'Gesdinet\\JWTRefreshTokenBundle\\Entity'), '.orm.yml'));

$a->addDriver($b, 'App\\Entity');
$a->addDriver($b, 'Gesdinet\\JWTRefreshTokenBundle\\Entity');
$a->addDriver($b, 'Vich\\UploaderBundle\\Entity');
$a->addDriver($c, 'Gesdinet\\JWTRefreshTokenBundle\\Entity');
$a->addDriver($c, 'Gesdinet\\JWTRefreshTokenBundle\\Entity');

$instance->setEntityNamespaces(array('App' => 'App\\Entity', 'GesdinetJWTRefreshTokenBundle' => 'Gesdinet\\JWTRefreshTokenBundle\\Entity', 'VichUploaderBundle' => 'Vich\\UploaderBundle\\Entity'));
...
$instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, array(
    'App\\Repository\\NetSuiteConfigurationRepository' => array('privates', 'App\\Repository\\NetSuiteConfigurationRepository', 'getNetSuiteConfigurationRepositoryService.php', true),
    'App\\Repository\\NetsuiteToRevelHistoryRepository' => array('privates', 'App\\Repository\\NetsuiteToRevelHistoryRepository', 'getNetsuiteToRevelHistoryRepositoryService.php', true),
    'App\\Repository\\RevelConfigurationRepository' => array('privates', 'App\\Repository\\RevelConfigurationRepository', 'getRevelConfigurationRepositoryService.php', true),
    'App\\Repository\\RevelToNetsuiteHistoryRepository' => array('privates', 'App\\Repository\\RevelToNetsuiteHistoryRepository', 'getRevelToNetsuiteHistoryRepositoryService.php', true),
    'App\\Repository\\RoleRepository' => array('privates', 'App\\Repository\\RoleRepository', 'getRoleRepositoryService.php', true),
    'App\\Repository\\SchedulerRepository' => array('privates', 'App\\Repository\\SchedulerRepository', 'getSchedulerRepositoryService.php', true),
    'App\\Repository\\SyncHistoryRepository' => array('privates', 'App\\Repository\\SyncHistoryRepository', 'getSyncHistoryRepositoryService.php', true),
