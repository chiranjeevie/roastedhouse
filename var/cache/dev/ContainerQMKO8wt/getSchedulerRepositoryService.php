...
// Returns the private 'App\Repository\SchedulerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SchedulerRepository.php';

return $this->privates['App\Repository\SchedulerRepository'] = new \App\Repository\SchedulerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
