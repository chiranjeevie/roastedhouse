...
// Returns the private 'App\Repository\RevelConfigurationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/RevelConfigurationRepository.php';

return $this->privates['App\Repository\RevelConfigurationRepository'] = new \App\Repository\RevelConfigurationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
