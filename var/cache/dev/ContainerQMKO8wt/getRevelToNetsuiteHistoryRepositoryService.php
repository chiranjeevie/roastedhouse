...
// Returns the private 'App\Repository\RevelToNetsuiteHistoryRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/RevelToNetsuiteHistoryRepository.php';

return $this->privates['App\Repository\RevelToNetsuiteHistoryRepository'] = new \App\Repository\RevelToNetsuiteHistoryRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
