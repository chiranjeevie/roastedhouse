...
// Returns the private 'App\Repository\NetSuiteConfigurationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/NetSuiteConfigurationRepository.php';

return $this->privates['App\Repository\NetSuiteConfigurationRepository'] = new \App\Repository\NetSuiteConfigurationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
